...
BASE_DIR = "/share/ai-lab/scandussio/stlenc_arch_mean" # Aggiornato per non sovrascrivere
...
def run_final_training():
    ...
    wandb.init(project="stlenc-arch", name="mean-onthefly", config=final_params)
